...
describe('AFi Oracle testcases', (accounts) => {
    ...
    it('queue flow check', async () => {
        ...
        await aFiPassiveRebalanceInstance.connect(investor1).setDexForTokenPair("0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831", 1);
