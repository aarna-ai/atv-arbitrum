...
describe('AFi Oracle testcases', (accounts) => {
    ...
    it('queue flow check', async () => {
        ...
        await aFiPassiveRebalanceInstance.connect(platformWallet).setDexForTokenPair("0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0", "0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", 1);

        let algorebaldata;
        try {

            let tokenIn = '0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0';  // Provide your tokenIn address
            let tokenOut = "0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9"; // Provide your tokenOut address
            let amountIn = '17257722259946703943';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;

            algorebaldata = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        try {
            ...
            let tokenIn = '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9';  // Provide your tokenIn address
            let tokenOut = '0xaf88d065e77c8cC2239327C5EDb3A432268e5831'; // Provide your tokenOut address
            let amountIn = '298519812';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;
            ...
            tokenIn = '0xaf88d065e77c8cC2239327C5EDb3A432268e5831';  // Provide your tokenIn address
            tokenOut = '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9'; // Provide your tokenOut address
            amountIn = '298254109';  // Amount to swap
        ...
        await aFiPassiveRebalanceInstance.connect(platformWallet).setDexForTokenPair("0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9", "0xaf88d065e77c8cc2239327c5edb3a432268e5831", 1);
        await aFiPassiveRebalanceInstance.connect(platformWallet).setDexForTokenPair("0xaf88d065e77c8cc2239327c5edb3a432268e5831", "0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9", 1);
        ...
        await expect(aFiAFiOracleInstance.connect(investor1).redeem(aTokenConInstance.address, ["0xdAC17F958D2ee523a2206206994597C13D831ec7"], 1)).to.be.revertedWith('AO26');

        console.log("check the balance", await usdtConInstance.balanceOf(investor1.address));
        console.log("check the batchCounter", await aFiAFiOracleInstance.batchWithdrawCounter(investor1.address));
        ...
        let uTokens = await aTokenConInstance.getUTokens()
        ...
        try {
            ...
            tokenIn = '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9';  // Provide your tokenIn address
            tokenOut = '0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f'; // Provide your tokenOut address
            amountIn = '1558515097';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;
            ...
            tokenIn = '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9';  // Provide your tokenIn address
            tokenOut = '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1'; // Provide your tokenOut address
            amountIn = '1558515097';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;
            ...
            tokenIn = '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9';  // Provide your tokenIn address
            tokenOut = '0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0'; // Provide your tokenOut address
            amountIn = '1558515097';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;
            ...
            tokenIn = '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9';  // Provide your tokenIn address
            tokenOut = '0xf97f4df75117a78c1A5a0DBb814Af92458539FB4'; // Provide your tokenOut address
            amountIn = '1558515097';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;
        ...
        var oneInchParam1 = {
            ...
            secondIterationCumulativeSwap: [oneInchdata1, oneInchdata2, oneInchdata3, oneInchdata4]
        }
        ...
        await aFiPassiveRebalanceInstance.connect(platformWallet).setDexForTokenPair("0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", "0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0", 1);
        await aFiPassiveRebalanceInstance.connect(platformWallet).setDexForTokenPair("0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", "0xf97f4df75117a78c1A5a0DBb814Af92458539FB4", 1);
        ...
        const reinitData = {
            ...
            oracles: oraclePayload1,  // your oracle addresses array
            defaultProp: [3000000, 3000000, 2000000, 2000000],
            currentProp: [3000000, 3000000, 2000000, 2000000]
        };

        // Create empty SiloData array
        const siloData = [{
            silo: "0x0000000000000000000000000000000000000000",
            assets: []
        }];

        // Create empty SiloSwapData
        const siloSwapData1 = {
            siloRewardTokens: [],
            minReturnSilo: [],
            siloOtoken: []
        ...
        const CSData = {
            csParam: swapParams,
            _siloData: [],
            _siloSwapData: siloSwapData1
        };

        await aFiManagerInstance.connect(platformWallet).reInitializeVault(
            aTokenConInstance.address,
            aFiStorageInstance.address,
            unipooldata1,
            reinitData,
