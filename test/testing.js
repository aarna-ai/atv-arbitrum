...
//         aFiStorageInstance = await AFiStorage.deploy(aFiManagerInstance.address, aFiAFiOracleInstance.address, aFiPassiveRebalanceInstance.address, {
//             maxPriorityFeePerGas: feeData.maxPriorityFeePerGas,
//             maxFeePerGas: feeData.maxFeePerGas,
//             type: 2
//         });
...
//         aFiTimeLockInstance = await AFiTimeDelayContract.deploy(100, 172800, {
//             maxPriorityFeePerGas: feeData.maxPriorityFeePerGas,
//             maxFeePerGas: feeData.maxFeePerGas,
//             type: 2
//         });
...
//         await expect(aFiAFiOracleInstance.connect(investor1).intializeStalePriceDelay(aTokenConInstance.address, [
...
//         const accountToInpersonate = "0x2d070ed1321871841245D8EE5B84bD2712644322"
...
//         var daiBalance = await daiConInstance.balanceOf(accountToInpersonate);
...
//         // it("deposit check with DAI", async () => {
...
//         //         1000000000000000000000n, daiConInstance.address
//         //     );
...
//         //     var uTokenBal = await aFiStorageInstance.balance("0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f", aTokenConInstance.address);
//         //     console.log("wbtc", `${uTokenBal}`);

//         //     uTokenBal = await aFiStorageInstance.balance("0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0", aTokenConInstance.address);
//         //     console.log("uni", `${uTokenBal}`);

//         //     uTokenBal = await aFiStorageInstance.balance("0xf97f4df75117a78c1A5a0DBb814Af92458539FB4", aTokenConInstance.address);
//         //     console.log("link", `${uTokenBal}`);
...
//         //     aTokenConInstance.connect(investor1).withdraw(
//         //         1978011115763833000n, daiConInstance.address, deadline, returnString, 1
//         //     );     
            
//         //     const NavfromStorageAfterWithdraw = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance.address, aFiStorageInstance.address);
//         //     console.log("Nav from storage after withdraw", `${NavfromStorageAfterWithdraw}`);
...
//         //     const AfterWithdrawbal = await aTokenConInstance.balanceOf(
//         //         investor1.address
//         //     );

//         //     var priceOfToken = await aFiAFiOracleInstance.getPriceInUSDC(aTokenConInstance.address, "0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f");
//         //     console.log("price of wbtc", `${priceOfToken}`);

//         //     priceOfToken = await aFiAFiOracleInstance.getPriceInUSDC(aTokenConInstance.address, "0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0");
//         //     console.log("price of uni", `${priceOfToken}`);

//         //     priceOfToken = await aFiAFiOracleInstance.getPriceInUSDC(aTokenConInstance.address, "0xf97f4df75117a78c1A5a0DBb814Af92458539FB4");
//         //     console.log("price of link", `${priceOfToken}`);

//         //     console.log("After Withdraw bal", `${AfterWithdrawbal}`);
//         // });
...
//             console.log("AfterWithdrawbal rebalance", `${AfterWithdrawbal}`);
...
//         //     uTokenBal = await aFiStorageInstance.balance("0x912ce59144191c1204e64559fe8253a0e49e6548", aTokenConInstance.address);
//         //     console.log("ARB", `${uTokenBal}`);
...
//         //     priceOfToken = await aFiAFiOracleInstance.getPriceInUSDC(aTokenConInstance.address, "0x912ce59144191c1204e64559fe8253a0e49e6548");
//         //     console.log("price of ARB", `${priceOfToken}`);
...
//         // it("active rebalance scenario 1 check with DAI when PR  = 1", async () => {
//         //     snapshotId = await ethers.provider.send('evm_snapshot');
//         //     const beforeUSDTDep = await usdtConInstance.balanceOf(investor1.address)
//         //     console.log("before Deposit user usdt balance", `${beforeUSDTDep}`)
...
//         // it("active rebalance scenario 2 check with DAI when PR = 1", async () => {
//         //     snapshotId = await ethers.provider.send('evm_snapshot');
//         //     const beforeUSDTDep = await usdtConInstance.balanceOf(investor1.address)
//         //     console.log("before Deposit user usdt balance", `${beforeUSDTDep}`)
