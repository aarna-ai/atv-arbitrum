    ...
    context('Basic checks for deposit and withdraw', () => {
        ...
        it('Stable product', async () => {
            ...
            var swapParams = {
                ...
                cSwapFee: 1,
                cSwapCounter: 0,
                depositTokens: ["0xaf88d065e77c8cC2239327C5EDb3A432268e5831"],
            ...
            await aTokenConInstance.connect(investor1).withdraw(
                Afterbal1, usdcConInstance.address, deadline, returnString, 3, 0
            );

            const AfterwithusdtBalance = await usdcConInstance.balanceOf(investor1.address)
