...
//         aFiAFiOracleInstance.intializeStalePriceDelay(aTokenConInstance.address, [
...
//         console.log("usdtBalance", usdtBalance)
//         await usdtConInstance.connect(signer).transfer(investor1.address, "20879035957569");
//         await usdtConInstance.connect(signer).transfer(investor2.address, "20879035957569");
...
//         it('should return the correct length of allUnderlyingTokens', async () => {
//             // ... (code for preparing the contract and any necessary state)
//             const length = await aFiFactoryInstance.allUnderlyingTokensLength();
//             assert.equal(length.toNumber(), 5, 'Length does not match the expected value');
//         });


//         it('should revert if Manager address is zero', async () => {
//             await expect(
//                 aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload2, [investor1.address], false, false, aFiStorageInstance.address,
...
//             await expect(
//                 aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload2, [constants.ZERO_ADDRESS], false, false, aFiStorageInstance.address,
...
//             await expect(
//                 aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload2, [investor1.address], false, false, constants.ZERO_ADDRESS,
//                     aFiPassiveRebalanceInstance.address, aFiManagerInstance.address, [investor1.address])
//             ).to.be.reverted;
//         });
...
//             await expect(
//                 aFiFactoryInstance.createAToken("AFiBase", "ATOK", MismatchedPayloadbytes2, [investor1.address], false, false, aFiStorageInstance.address,
...
//             await expect(
//                 aFiFactoryInstance.createAToken("AFiBase", "ATOK", zeroPayloadbytes2, [investor1.address], false, false, aFiStorageInstance.address,
...
//             try {
//                 await aFiFactoryInstance.createAToken("AFiBase", "ATOK", payloadbytes, [investor1.address, investor2.address], false, false, aFiStorageInstance.address,
...
//             try {
//                 await aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload, [], false, false, aFiStorageInstance.address,
//                     aFiPassiveRebalanceInstance.address, aFiManagerInstance.address, [investor1.address]);
//                 assert.fail("Expected transaction to be reverted");
//             } catch (error) {
...
//         it('should revert if underlying tokens contain zero address', async function () {
//             var payload = [
//                 [
...
//             try {
//                 await aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload, [investor1.address], false, false, aFiStorageInstance.address,
//                     aFiPassiveRebalanceInstance.address, aFiManagerInstance.address, [investor1.address]);
//                 assert.fail("Expected transaction to be reverted");
//             } catch (error) {
//                 assert.include(error.message, 'zero addr', 'Revert message does not match');
//             }
...
//             try {
//                 await aFiFactoryInstance.createAToken("AFiBase", "ATOK", invalidPayload, [investor1.address], false, false, aFiStorageInstance.address,
//                     aFiPassiveRebalanceInstance.address, aFiManagerInstance.address, [investor1.address]);
//                 assert.fail("Expected transaction to be reverted");
//             } catch (error) {
...
//         // it('should revert if _aTokenImplementation address is zero', async () => {
//         //     try {
//         //         await AFiFacotry.deploy(constants.ZERO_ADDRESS);
//         //         assert.fail("Expected deployment to be reverted");
//         //     } catch (error) {
//         //         assert.include(error.message, 'AF02', 'Revert message does not match');
//         //     }
