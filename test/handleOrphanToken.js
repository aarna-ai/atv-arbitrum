...
describe('AFi Product 101', function (accounts) {
    ...
    describe('Basic checks for deposit and withdraw', () => {
        ...
        it("algo rebalance and reinitialize on the vault", async () => {
            ...
            await aTokenConInstance.handleOrphenTokens(
            ...
            try {
                ...
                const tokenIn = uniConInstance.address;  // Provide your tokenIn address
                const tokenOut = usdcConInstance.address; // Provide your tokenOut address
                const amountIn = '1000000000000000';  // Amount to swap
            ...
            await uniConInstance.connect(signer3).transfer(aTokenConInstance.address, 1000000000000000);
            ...
            await aFiPassiveRebalanceInstance.connect(investor1).setDexForTokenPair(uniConInstance.address, usdcConInstance.address, 1);
